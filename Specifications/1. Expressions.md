...
A special kind of expression called a **don't care fixed-width numeric** is allowed here. These are fixed width binary, octal or hexadecimal numerics with an "z" in place of a digit, meaning the value of this digit can be ignored.
